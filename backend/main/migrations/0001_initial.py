# Generated by Django 4.2.20 on 2025-04-30 10:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_categories', models.ManyToManyField(to='main.categories', verbose_name='Категории')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_course', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='main.courses', verbose_name='Курс')),
            ],
            options={
                'verbose_name': 'Урок',
